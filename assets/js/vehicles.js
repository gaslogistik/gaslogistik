/* ============================================================
VEHICLES.JS — v4 (2026-08-07) — BEZ SPINNERA
🔧 v4:
 • CAŁA logika spinnera USUNIĘTA z JS — zamiast tego nakładka
   #loading-spinner jest UBIJANA natychmiast po starcie skryptu
   i na każdej ścieżce ładowania (killSpinnerOverlay),
 • WATCHDOG pozostał jako bezpiecznik (ubija nakładkę po 60 s),
 • reszta identyczna jak v3 (działała!): SWR z localStorage, pigułka,
   baner offline z powodem, prefetch+race, safeSection, vGet.
============================================================ */
const API_URL =
...
/* ============================================================
🔧 v4: UBIJANIE NAKŁADKI ŁADOWANIA — wywoływane ZAWSZE i WSZĘDZIE
============================================================ */
function killSpinnerOverlay() {
...
console.warn("WATCHDOG: awaryjne ukrycie nakładki po " + CFG.WATCHDOG_MS + " ms");
killSpinnerOverlay();
}, CFG.WATCHDOG_MS);
}
function disarmOverlayWatchdog() {
if (overlayWatchdog) { clearTimeout(overlayWatchdog); overlayWatchdog = null; }
}
...
/* ---------- FETCH (timeout na CAŁĄ odpowiedź) ---------- */
...
killSpinnerOverlay();   // 🔧 v4: nakładka znika NATYCHMIAST, zawsze
injectHighlightStyles();
bootstrapVehicles();
});
function bootstrapVehicles() {
killSpinnerOverlay();   // 🔧 v4: podwójny bezpiecznik
armOverlayWatchdog();
...
/* ---------- TWARDE ŁADOWANIE (bez spinnera — widać "--" i dane wskakują) ---------- */
...
parseDate, fmtDate, showErrorState, killSpinnerOverlay,
};
